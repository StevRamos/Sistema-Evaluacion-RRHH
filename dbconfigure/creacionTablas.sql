...
CREATE TABLE IF NOT EXISTS `db_sed`.`Gerencia_Periodos` (
  ...
  `fechaInicioEvalPrevD` DATE NULL,
  `fechaFinEvalPrevD` DATE NULL,
  `fechaInicioEvalFinD` DATE NULL,
  `fechaFinEvalFinD` DATE NULL,
  `fechaInicioCal` DATE NULL,
  `fechaFinCal` DATE NULL,
  `activo` TINYINT(1) NULL,
...
CREATE TABLE IF NOT EXISTS `db_sed`.`LineasEvaluacion` (
  ...
  `activo` TINYINT(1) NULL,
  `fechaCumplimientoPDI` DATE NULL,
...
-- -----------------------------------------------------
-- Table `db_sed`.`Usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_sed`.`Usuarios` (
  `id_Usuario` INT NOT NULL,
  `contrasenha` VARCHAR(150) NULL,
  `contrasenhaAnterior` VARCHAR(150) NULL,
  `estadoCuenta` TINYINT(5) NULL,
  `nivelAcceso` TINYINT(3) NULL,
  INDEX `fk_Usuarios_Colaboradores1_idx` (`id_Usuario` ASC) VISIBLE,
  PRIMARY KEY (`id_Usuario`),
  CONSTRAINT `fk_Usuarios_Colaboradores1`
